...
![CI Pipeline](https://github.com/aaru-privacy/aaru-new-moon-level-4/actions/workflows/ci.yml/badge.svg)
...
git clone https://github.com/aaru-privacy/aaru-new-moon-level-4.git
cd aaru-new-moon-level-4
