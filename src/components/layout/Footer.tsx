      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-3 text-center sm:text-left">
            ...
            <div>
              <div className="flex items-center justify-center sm:justify-start space-x-2">
                <span className="font-extrabold text-white tracking-wide">AARU ECLIPSE</span>
                <span className="text-xs text-slate-500">•</span>
                <span className="text-xs text-cyan-400 font-medium">Level 5 & 6 Sealed-Bid ZK Engine</span>
              </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 text-xs">
            {/* Verified X (Twitter) Profile */}
            <a
              href="https://x.com/aaruarya_13"
              target="_blank"
              rel="noreferrer"
              className="flex items-center space-x-2 px-3 py-1.5 rounded-lg bg-slate-900 border border-slate-700/80 text-slate-200 hover:border-cyan-500/60 hover:text-cyan-400 hover:shadow-lg hover:shadow-cyan-950/40 transition-all font-semibold"
            >
