      ...
      <div className="relative rounded-3xl overflow-hidden border border-cyan-500/30 shadow-2xl shadow-cyan-950/40 bg-slate-950 group">
        <div className="relative h-48 sm:h-56 w-full">
          <img
            ...
            alt="Aaru Eclipse Protocol Header Banner"
            className="w-full h-full object-cover opacity-90 group-hover:scale-[1.01] transition-transform duration-700"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#070913] via-[#070913]/85 to-transparent" />
          ...
          <div className="absolute inset-0 p-6 sm:p-8 flex flex-col justify-between z-10">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                <img
                  src="/logo.jpg"
                  alt="Aaru Eclipse Logo"
                  className="w-10 h-10 rounded-xl border border-cyan-400/50 shadow-lg object-cover"
                />
                <div>
                  <h1 className="text-xl sm:text-2xl font-black text-white tracking-tight flex items-center gap-2">
                    <span>AARU ECLIPSE ZK ENGINE</span>
                    <span className="px-2.5 py-0.5 text-[10px] font-extrabold uppercase rounded-full bg-cyan-500/20 text-cyan-300 border border-cyan-400/40">
                      Preprod Live
                    </span>
                  </h1>
                  <p className="text-xs text-slate-300 font-medium">
                    Zero-Knowledge Multi-Lot Sealed-Bid Auction & Trustless <code className="text-emerald-300">ttDUST</code> Escrow Vault
                  </p>
                </div>
              </div>
              ...
              {onOpenXProfile && (
                <button
                  ...
                  className="hidden sm:flex items-center space-x-2 px-4 py-2 rounded-xl text-xs font-bold bg-slate-900/90 text-cyan-300 border border-cyan-500/50 hover:border-cyan-400 hover:text-white hover:shadow-lg hover:shadow-cyan-950/80 active:scale-95 transition-all backdrop-blur-md"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
              <div className="bg-slate-900/80 backdrop-blur-md border border-slate-800 rounded-xl p-2.5">
                <span className="text-[10px] uppercase font-semibold text-slate-400 block">Total Collateral Locked</span>
                <span className="text-base font-extrabold text-white font-mono">{contractState.totalEscrowLocked} ttDUST</span>
              </div>
              <div className="bg-slate-900/80 backdrop-blur-md border border-slate-800 rounded-xl p-2.5">
                <span className="text-[10px] uppercase font-semibold text-slate-400 block">Active Commitments</span>
                <span className="text-base font-extrabold text-cyan-400 font-mono">{contractState.bidCommitments.length} Sealed Bids</span>
              </div>
              <div className="bg-slate-900/80 backdrop-blur-md border border-slate-800 rounded-xl p-2.5">
                <span className="text-[10px] uppercase font-semibold text-slate-400 block">Privacy Guarantee</span>
                <span className="text-base font-extrabold text-indigo-300 font-mono">100% ZK Poseidon</span>
              </div>
              <div className="bg-slate-900/80 backdrop-blur-md border border-slate-800 rounded-xl p-2.5">
                <span className="text-[10px] uppercase font-semibold text-slate-400 block">Settlement Model</span>
                <span className="text-base font-extrabold text-emerald-400 font-mono">Vickrey 2nd-Price</span>
              </div>
            </div>
          </div>
        </div>
